...
public class ArticleClickCountServiceImpl implements ArticleClickCountService{
	...
	@Override
	public int updateClickCountBatch(Integer columnId, Integer userId, String articleIds) {
		int updateResutl = articleDao.batchUpdateArticleClickCount(articleIds);
		int saveResutl = articleClickCountDao.batchSave(columnId, userId, articleIds);
