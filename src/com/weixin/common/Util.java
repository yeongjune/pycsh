...
public class Util {
     ...
     */
    public static String getLoginUrl(String targetUrl){
        return getLoginUrl(targetUrl, "snsapi_userinfo");
    }
     ...
     */
    public static String getLoginUrl(String targetUrl, String scope){
