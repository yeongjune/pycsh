...
import com.weixin.common.XMLParser;
...
public class ClickEvent {
    ...
    public static String push(Map<String, Object> xmlMap){
        String key = (String) xmlMap.get("EventKey");
        ...
        for (int i = 0; i < methods.length; i++) {
            ...
            if(state != null && state.type() != null && state.value() != null
                ...
                try {
                    return (String) method.invoke(null, xmlMap);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
    ...
    @EventState(value = {"activity_consultation"})
    public static String activityConsultation(Map<String, Object> xmlMap){
        ...
        String content = (String) xmlMap.get("EventKey");
