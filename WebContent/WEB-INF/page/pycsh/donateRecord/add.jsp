...
<body onunload="removeObject()">
	<form action="">
		...
		<div class="form_item">
			...
			<input type="text" id="targer" class="piece" style="width:500px;" value="${project.targer }"  onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"/>
		</div>
		<div class="form_item">
