...
$(function(){
	...
	function loadList(list){
		...
		for(var item in list){
			...
			html+='<td ><a href="javascript:void(0);" onclick="selectDonate('+poj.id+')">捐款</a></td>';
...
function selectDonate(id){
	art.dialog({
		content :"捐款金额 <input type='text' id='money' value='${lastMoney}' /> ",
		width: 200,
		height: 100,
		title:'捐款金额',
		close: function (){
		...
		ok:function(){
			...
			$.post("/donateRecord/saveSelectDonate.action",{"projectId":id,"donateId":"${donateId}","money":$("#money").val()},function(e){
				alert("操作成功!");
				loadProject();
			},"text");
		}
