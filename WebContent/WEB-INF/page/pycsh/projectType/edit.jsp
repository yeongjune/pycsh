...
<script type="text/javascript">
	...
	function ProjectAdd(){
		...
		this.save = function(){
			...
			$.post(url, {name: name,pId:pId,id:"${project.id}",sort:sort}, function(data){
				openLock();
				if(data=='succeed'){
...
<body onunload="removeObject()">
	<form action="">
		...
		<div class="form_item div_title_1_1">
			...
			<input type="text" id="name" class="piece" style="width:200px;" value="${project.name }" maxlength="200" />
		</div>
		<div class="form_item div_title_1_1">
