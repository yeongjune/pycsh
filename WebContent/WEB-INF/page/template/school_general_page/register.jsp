...
.label{width: 70px;display: inline-block;height: 20px; line-height: 20px;}
.student, .teacher{margin: 0 7px 0 0;}
</style>
 ...
 <form id="registerForm" method="post" onsubmit="return false;">
	...
	<div class="msgBoxContent">
		...
		<div class="form_item">
			...
			<!-- <input type="text" class="piece" name="identity" id="identity" maxlength="20" placeholder="学生/老师..."/> -->
		...
		<div class="form_item">
			<span class="form_span">班别/部门：</span>
			<input type="text" class="piece" name="department" id="department" maxlength="20" placeholder="部门/班别等..."/>
			<span style="color:red"></span>
		</div>
