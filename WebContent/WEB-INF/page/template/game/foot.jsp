...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
            <!-- 浮动栏 -->
            <div class="er_top">
                <div class="er"><img src="/template/${site.directory }/images/er.png" alt="" />微信扫描</div>
                <a href="#"> <div class="top">返回顶部</div></a>
                <div class="er_img"><img src="/template/${site.directory }/images/weixin.jpg" alt="" height="160" /></div>
            </div>
