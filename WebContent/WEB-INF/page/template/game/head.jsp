...
function toUserInfo(){
	$.getJSON("http://www.pycs.org.cn/weixinUser/toLoginMain.action?callback=?",{n:pa.n,date:new Date(),w:pa.p},function(data){
		
		location.href="http://www.pycs.org.cn/go-userInfo.html";		
	},"json");
}
...
function logout(){
	...
	$.post("/weixinUser/logout.action",{},function(e){
		if(e){
			$.getJSON("http://www.pycs.org.cn/weixinUser/logoutMain.action?callback=?",{},function(e){
				if(e){
					location.reload();
				}
			});
 ...
 <div class="header">
            <div class="wrap">
                ...
                <div class="header_bottom">
                    <h1 class="logo"><a href="/go-index.html"><img src="/template/${site.directory }/images/logo.png" alt="" /></a></h1>
                    <div class="nav">
                        <ul>
                        <li><a href="/go-index.html">首页</a></li>
                      <c:forEach items="${菜单}" var="item">
        ...
        <div class="banner">
         ...
         <c:forEach items="${图片轮播}" var="item">
            ...
            <!-- 指示器 -->
                <ol>
                  <c:forEach items="${图片轮播}" var="item" varStatus="status">
