...
<script type="text/javascript"	src="/js/site/editPwd_en.js"></script>
</head>
<body style="padding-top: 45px">
 <form id="editPwdForm" method="post">
 	<input id="url" type="hidden" value="${url}" />
 	<div style="text-align: center;font-size: 20px;font-weight: bold;">Edit Password</div>
	<div class="msgBoxContent">
		<div class="form_item">
			<span class="form_span">Original Password：</span>
		...
		<div class="form_item">
			<span class="form_span">Repetive Password：</span>
