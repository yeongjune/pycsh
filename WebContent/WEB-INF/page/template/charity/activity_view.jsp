...
$(function(){
	...
	function loadList(list){
		...
		for(var item in list){
			...
			html+='<li><span>'+record.name+'</span><span><font class="orange_2">￥ '+record.money+'</font>元</span><span class="t_right">'+record.createTimeFormat+'</span></li>';
	...
	function loadFile(){
		$.post("/activityFront/loadFile.action",{id:"${id}"},function(e){
			for(var i=0;i<e.length;i++){
				$("#fileBody").append('<li><a href="'+e[i].path+'">'+e[i].fileName+'</a>');
			}
			$("#fileDiv").show();
		},"json");
	}
...
<div class="box">
    ...
    <div class="left_xq">
        ...
        <div style="display: none;" id="fileDiv" class="j_tit">附件列表</div>
        	<ul id="fileBody" style="position: relative;">
  ...
  <div class="right_xq">
     <div class="r_mo_o" style="width: 370px;">
     	<div class="r_m_l">活动状态 : <font class="orange_2" id="status"></font></div>
        <div class="r_m_o_b">
        	已筹 <font class="orange_2" id="pojMoney">0</font> 元 　已有 <font class="orange_2" id="pojCount">0</font> 人报名 <br>
        ...
        <div class="r_m_j">
         ...
         <div class="r_m_j">
        	...
        	<div class="r_m_input" style="width: 210px;">
           		<input type="text" name="exPhone"  id="exPhone" style="width: 200px;"  onkeydown="onlyNum();" onfocus="putMoney();"/>
            </div>
        </div>
        ...
        <div class="btn_g2" id="donateDiv"><a href="javascript:void(0);" onclick="submitDonate();">我要报名</a></div>
     </div>
     <div id="isClose">
	     <div class="clear"></div>
	        
	        <div class="btn_g2" id="donateDiv"><a href="javascript:void(0);" style="background:#999;">已结束报名</a></div>
	     </div>
     </div>
