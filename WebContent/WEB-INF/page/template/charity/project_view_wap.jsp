...
<body class="bj">
	<div class="box" onclick="hideDonate();" style="margin-bottom: 60px;" id="viewDiv">
        ...
        <div class="j_nav">
            ...
            <div class="line"></div>
        	<a>已筹 <font class="orange">￥<span id="pojMoney">0</span></font> 元</a><a style=" border:0;">捐款人数 <font class="orange"><span id="pojCount">0</span></font> 人</a>
        </div>
...
<div class="download_msg" id="donateBtn">
		<div class="j_btn" style=" margin:0 auto"><a href="javascript:void(0);" onclick="showDonate();">我要捐赠</a></div>
</div>


<div class="download_msg2" style="display: none;" id="donateDiv">
	<div style="background: #000; opacity: 0.6;height: 1000px;width: 100%;"></div>
	<div style="background: #FFF">
	
    <div class="m_o_tl">我要捐赠</div>
    <div class="m_o_tr" onclick="hideDonate();">X</div>
    <div class="clear"></div>
    <div class="line"></div>
    ...
    <div class="do_list">
        ...
        <a href="javascript:void(0);" onclick="selectMoney(this,100);" style=" margin:0"><font class="orange">100</font>元</a>
      <div class="clear"></div>
    </div>
    <input type="hidden" name="money" id="money"/>
	<input type="hidden" name="projectId" value="${id }"/>
    <div class="do_input"><input type="text" id="otherMoney" onfocus="$('.do_list').find('a').removeAttr('style');$('.do_list').find('font').attr('class','orange');" onkeydown="onlyNum();" style="ime-mode:Disabled" /><div class="yuan">元</div></div>
    <div class="j_btn" style=" margin:10px auto;"><a href="javascript:void(0);" onclick="donate();">我要捐赠</a></div>
    <div class="ty_g"><a href="javascript:void(0);" onclick="checkDon();"><input onclick="event.stopPropagation();" checked="checked" type="checkbox"  value="" id="xyCheck">同意</a><a href="javascript:void(0);" onclick="viewText();">《番禺慈善会公益用户协议》</a></div>
    </div>
</div>
