	...
	<div class="box">
	  <table id="table_${stu.id }" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_border2">
		...
		<tr>
	      ...
	      <td colspan="3" style="text-align: left; padding-left:10px;">家庭住址</td>
	      <td colspan="2" >
		 	<table class="tab_3">
	  ...
	  <script type="text/javascript">
	  	$(function(){
	  		if($("#table_${stu.id} span[title='${stu.companyName}']").size()>0){
	  	 		$("#table_${stu.id} span[title='${stu.companyName}']").html('&#8730;');
	  	 	}
	  	});
	 	</script>
	</div>
