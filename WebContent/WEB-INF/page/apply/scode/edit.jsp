...
function EidtScode(id){
	this.id=id;
	this.load = function (){
		$.post('/student/load.action',{id:id},function(data){
	...
	this.save = function (){
		...
		$.post('/scode/save.action',{id:this.id,interview:interview,interviewScore:interviewScore,admit:admit},function(data){
			if(data.code=='fail'){
