...
<form id="studentForm" action="">
	...
	<tr>
		...
		<td class="text">
			<span >
				<input name="birthday"  value='<fmt:formatDate value="${student.birthday }" pattern="yyyy-MM-dd" />' type="text" class="piece required" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',startDate:'${student.birthday}'})"  maxlength="10" />
			</span>
			<span class="red">*</span>
		</td>
