...
.table_border2 td{ border: 1px solid #DEDEDE; text-align: center; line-height: 35px; font-size:16px; }
...
<c:forEach var="stu" items="${dzStudentList }" varStatus="i">
	...
	<div class="box">
	  <table id="table_${stu.id }" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_border2">
		...
		<tr>
	      <td colspan="2" style="text-align: left; padding-left:10px;">毕业学校：${stu.graduate }</td>
	      <td colspan="2" >曾任何种职务</td>
	      <td style="text-align: left; padding-left:10px;">　${stu.position }</td>
	    </tr>
		<tr>
	      <td >籍贯</td>
	      ...
	      <td colspan="3">
		  	<table class="tab_3">
				...
				<tr><td>是否农业户口：${stu.isPeasant}</td></tr>
			</table>	  </td>
	    </tr>
		<tr>
	      <td width="150">家庭住址</td>
	      <td colspan="3" style="text-align: left; padding-left:10px;">${stu.homeAddress }</td>
	      <td colspan="2" >
		 	<table class="tab_3">
				<tr><td colspan="2" style=" border:0;">家庭电话：${stu.homePhone }</td></tr>
				<tr>
					<td >父亲手机：${stu.fatherPhone }</td>
					<td>母亲手机：${stu.matherPhone }</td>
				</tr>
			</table>	  </td>
	    </tr>
		
		<tr>
	      <td colspan="4" style=" text-align: left; padding-left:10px;">父亲身份证号码：${stu.fatherIDCard }</td>
	      <td colspan="2" style=" text-align: left; padding-left:10px;">母亲身份证号码：${stu.motherIDCard}</td>
	    </tr>
		...
		<tr>
	      <td width="150">学科竞赛获奖情况<br>（区级以上）</td>
	      <td colspan="5" style="border-top:none" >
		  	<table class="tab_3">
				<tr><td style=" border:0;">${stu.rewardHobby }&nbsp;</td></tr>
			</table>
		</td>
	    </tr>
		 <tr>
		 ...
		 <tr><td colspan="6"   style="border:0; text-align: left; font-size:14px; color:#999">面试时间：${stu.interviewDate }，面试教室：${stu.roomNo }</td></tr>
