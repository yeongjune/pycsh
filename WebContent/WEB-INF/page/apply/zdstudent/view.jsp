...
<div class="head_Img_Div">
	<img id="headPicUrl" class="headImg" alt="点击看大图" src="${student.headPicUrl }" />
		...
		<div class="form_item" >
			...
			<span id="inSchoolNo">${student.inSchoolNo}</span>
		</div>
		<div class="form_item" >
			<span class="form_span" >是否广州学籍：</span>
			<span id="inSchoolNo">${student.isGZSchoolNo == 1 ? '是' : '否' }</span>
		</div>
		<div class="form_item" >
			<span class="form_span" >广州学籍号：</span>
			<span id="inSchoolNo">${student.inGzSchoolNo}</span>
		</div>
		<div class="form_item" >
		...
		<div class="form_item" >
			<span class="form_span" >是否农村户口：</span>
			<span id="IsPeasant">${student.IsPeasant == 1 ? '是' : '否'}</span>
		</div>
		<div class="form_item" >
