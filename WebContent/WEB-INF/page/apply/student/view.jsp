...
<div style="width:100%;line-height: 25px;text-align: left;">
    <a id="printStudent" href="/student/toPrintPage.action?ids=${student.id}" target="_blank" style="margi-top: 10px;margin-left:40px;cursor: pointer;border:solid 1px #ccc;padding:5px 10px;" >打印</a>
</div>
	...
	<img id="headPicUrl" class="headImg" alt="点击看大图" src="${student.headPicUrl }" />
		...
		<div class="form_item" >
			...
			<c:choose>
				...
				<c:when test="${student.status==0 }">审核回退(${student.checkRemark })</c:when>
			</c:choose>
			</span>
		</div>
		<div class="form_item" >
			<span class="form_span" >证件号码：</span>
			<span id="certificate">${student.certificate} ${student.certificateType}</span>　
		</div>
		<div class="form_item" >
			<span class="form_span" >小学学籍号：</span>
			<span id="enrollmentNumbers">${student.enrollmentNumbers}</span>
		</div>
		<div class="form_item" >
		...
		<div class="form_item" >
			...
			<span id="nativePlace">${student.nativePlace}</span>
		</div>
		<div class="form_item" >
		...
		<div class="form_item" >
			...
			<span id="phoneNumber">${student.phoneNumber}</span>
		</div>
		<div class="form_item" >
