...
<script type="text/javascript">
	$(function() {
		getDonateSum();
		loadByPage('/projectFront/loadList.action', {
			"type1" : $("#type1").val(),
			"name" : $("#name").val()
		}, loadList);
	...
	function loadList(list) {
		...
		for ( var item in list) {
			...
			html += '<div class="i_l_img" style="width:90px;overflow: hidden;"><a href="/go-project_view_wap.html?id='
					+ poj.id
			...
			html += '<div class="i_l_t_t"><a href="/go-project_view_wap.html?id='
			...
			html += '<div class="block left">'
					+ poj.typeName
					+ '</div>已捐赠 <font class="orange" id="pojCount'+poj.id+'">0</font> 份爱心 ';
			html += '</div>';
			html += '</div>';
	...
	function loadRecord() {
		...
		$.post("/projectFront/loadRecordStatistics.action", $("#recordForm")
	...
	function toView(id) {
		window.location.href = "/go-project_view_wap.html?id=" + id;
	}
