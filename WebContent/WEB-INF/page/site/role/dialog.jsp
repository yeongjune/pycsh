...
<head>
	...
	var setting = {
		...
		function roleTreeOnCheck(event, treeId, treeNode) {
			if(static_userId){
			    $.post('/userColumnRole/update.action',{userId:static_userId,roleId:treeNode.id,checked:treeNode.checked?1:0},function(data){
			    	initTree();
			    });
			}
		}
		...
		function reloadRole(){
			$.post('/userColumnRole/roleList.action',{userId: static_userId},function(data){
