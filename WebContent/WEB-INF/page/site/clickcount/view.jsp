		...
		<form action="">
		    <div style="float:left;">
				...
				<div class="form_item" id="div_content">
					...
					<div class="form_span div_content"  id="content">${article.content }</div>
				</div>
						...
						<div class="right_introduction">
							<c:forEach var="file" items="${fileList }">
								<div class="progressContainer blue" >
									<div class="progressName"><a href="${file.path }" target="_blank">${file.fileName}</a></div>
