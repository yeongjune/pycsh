...
<head>
	...
	var setting = {
		...
		function urlTreeOnCheck(event, treeId, treeNode) {
		    $.post('/authorityPublicUrl/update.action',{id:treeNode.id,checked:treeNode.checked?1:0},function(data){
		...
		function reloadUrl(){
			$.post('/authorityPublicUrl/load.action',{},function(data){
