	...
	this.login = function (){
		...
		if(siteUserLogin.times>3){
			if(validCode){
				...
				$("#validError").text("请输入验证码");
				pass=false;
			}
		}
		if(pass){
			$.post('/siteUser/doLogin.action',{acount:acount,password:hex_md5(password),times:siteUserLogin.times,validCode:validCode},function(data){
