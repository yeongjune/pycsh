...
<div>
	...
	<a href="#" class="base_btn" id="btnUpload_<%=index%>"><span>上传图片</span></a>
...
<script type="text/javascript">
	...
	function myUploadStart(){
		swfu.addPostParam("directory","/upload/contact/"); 
	    swfu.addPostParam("newFileNew","1"); 
	}
	//上传成功后处理
