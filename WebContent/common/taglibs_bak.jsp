...
<!-- css import -->
<link href="${css }/skins/default/css/base.css" rel="stylesheet" type="text/css" />
...
<!-- 弹出框引入 -->
<script type="text/javascript" src="/plugin/artDialog4.1.7/artDialog.js?skin=blue"></script>
