...
<div>
	...
	<a href="#" class="base_btn" id="btnUpload_<%=index%>" style="background: #409c5a"><span style="background: #409c5a">上传图片</span></a>
	...
	(function() {
		try {
			...
			var settings = {
				...
				upload_url : "/cshImage/save.action?type="+'${param.type}',
